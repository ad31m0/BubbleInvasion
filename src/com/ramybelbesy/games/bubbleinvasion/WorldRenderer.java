...
import com.ramybelbesy.games.framework.gl.LookAtCamera;
import com.ramybelbesy.games.framework.gl.SpriteBatcher;
import com.ramybelbesy.games.framework.gl.TextureRegion;
import com.ramybelbesy.games.framework.impl.GLGraphics;
...
//		ambientLight.enable(gl);
	...
	private void renderShip(GL10 gl, Gun ship) {
		if (ship.state == Gun.SHIP_EXPLODING) {
			gl.glDisable(GL10.GL_LIGHTING);
			...
			gl.glRotatef(ship.velocity.x / Gun.SHIP_VELOCITY * 90, 0, 0, -1);
	...
	private void renderInvaders(GL10 gl, List<Bubble> invaders, float deltaTime) {
